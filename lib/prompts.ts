...
4. While guiding — SCREEN FIRST, ALWAYS:
   ...
   - When a form field needs text, call provide_text with the exact text ready to copy (e.g. their name; transliterate to Devanagari or the form's language if the form needs it). Keep field_hint short ("Name field", "Address").
