...
> "900 million Indians are online, but sarkari websites assume you read English and know where to click. One confusing form means a day lost at a cyber café — or a missed pension."
...
### 1:30–1:52 · Slide 5 (Why)
> "Why this approach? Because it works on *every* government website *today* — zero changes needed from the government. Redesigning portals takes years; reading the citizen's screen ships now. Chatbots tell you steps — JanSewak *shows* you, on your own screen. And trust is built in: her profile never leaves the device, and she refuses to handle OTPs, Aadhaar numbers, or passwords."

### 1:52–2:00 · Slide 6 (Vision + close)
